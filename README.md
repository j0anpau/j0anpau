...
[![My Skills](https://skillicons.dev/icons py,matlab,mysql, mongodb, linux, pytorch,r,tensorflow,vscode,docker,arduino,raspberrypi,aws,gcp,azure, git)](https://skillicons.dev)
